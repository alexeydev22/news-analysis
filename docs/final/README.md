...
- `coursework-defense-presentation.pptx` — презентация на 15 слайдов;
- `assets/architecture-diagram.png` — архитектурная схема;
- `assets/chat-page.png`, `assets/ml-report-page.png`,
  `assets/topic-forecast-page.png` — скриншоты трех ключевых страниц;
...
классификацию влияния, обучение режимов моделей, подключаемую языковую модель, MLflow,
...
Примечание: `.docx` и `.pptx` собраны генераторами из фактов проекта и
актуальных скриншотов приложения. В финальные файлы внесены данные студента:
Прудиев Алексей Сергеевич, группа ПМ23-4, Финансовый университет при
Правительстве РФ, руководитель - доцент Романова Екатерина Владимировна.
